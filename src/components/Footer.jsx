  ...
  return (
    <footer className="bg-[#0A031E] border-t border-[rgba(255,255,255,0.05)] px-4 sm:px-6 lg:px-12 py-8 sm:py-12 font-['Inter']">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto pt-6 border-t border-[rgba(255,255,255,0.05)] flex flex-col sm:flex-row justify-between items-center gap-4">
