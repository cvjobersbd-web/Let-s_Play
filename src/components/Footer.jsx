...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0A031E] border-t border-[rgba(255,255,255,0.05)] px-6 lg:px-12 py-12 font-['Inter']">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-[#6B5F8A] text-sm leading-relaxed max-w-xs">
            {t.brandDesc}
          </p>
          <div className="flex gap-4 mt-4">
            <a href="#" className="text-[#6B5F8A] hover:text-[#E91E8C] transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {[t.home, t.games, t.blog, t.store, t.contact].map(item => (
              <li key={item}>
                <a href="#" className="text-[#6B5F8A] text-sm hover:text-white transition-colors">{item}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {['PG', 'JILI', 'SPRIBE', 'Pragmatic', 'Evolution', 'BNG', 'FC', 'MEGA'].map(item => (
              <li key={item}>
                <a href="#" className="text-[#6B5F8A] text-sm hover:text-white transition-colors">{item}</a>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="text-[#6B5F8A] text-sm flex items-start gap-3">
          ...
          <button className="mt-4 bg-[#E91E8C] text-white border-none px-5 py-2.5 rounded-full text-xs font-bold tracking-[1.5px] cursor-pointer transition-all duration-300 shadow-[0_4px_20px_rgba(233,30,140,0.3)] hover:bg-[#c4155a] hover:scale-105">
            {t.letsTalk}
          </button>
        </div>
      </div>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto mt-10 pt-6 border-t border-[rgba(255,255,255,0.05)] flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="text-[#4A3F5E] text-sm">
